...
const SITE_ORIGIN = 'https://www.player-fund.com';
const FROM_EMAIL = 'Player Fund Inc <noreply@hamiltonportfolio.com>'; // shared verified Resend domain across all three sites
